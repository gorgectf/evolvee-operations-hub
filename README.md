...
- Stock levels per SKU with low-stock flags (Zoho Inventory)
- Product sales — best and slow sellers (Shopify)
- Top customers (Shopify + Zoho CRM)
- Revenue by day / week / month (Shopify + Zoho Books)
...
Collabs), returns (AfterShip Returns), expenses/profit (Zoho Books expenses), Marketing
Performance (Klaviyo).
