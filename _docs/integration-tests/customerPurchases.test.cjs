...
const { aggregateCustomerPurchases } = require('../../backend/src/services/customerPurchases.js');
...
function test() {
    ...
    return 'aggregateCustomerPurchases: 1 customer, favorite + history checked';
}

module.exports = { name: 'customerPurchases aggregate', test };
